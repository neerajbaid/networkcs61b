...
public class Board {
  ...
  public DList findAllNetworks(int color) {
    ...
    System.out.println("first beginning piece: "
        + beginningZonePieces.front().item().toString());
    ...
    while (length > 0) {
      ...
      if (network == null)
        System.out
            .println("returned completed network, network is null");
      else
        System.out
            .println("returned completed network, network is not null");
      if (network != null)
  ...
  public Chain findNetwork(Piece piece, Chain currentNetwork,
    ...
    if (pieceIsInTargetEndZone(piece, currentNetwork)) {
      ...
      System.out.println("complete network one: "
    ...
    for (int direction : DIRECTIONS) {
      ...
      if (nextPiece == null) {
        ...
        System.out.println("current network before copy: "
            + currentNetwork.toString());
        Chain next = currentNetwork.copy();
        System.out.println("current network before adding: "
            + next.toString());
        System.out.println("next piece: " + nextPiece.toString());
        next.addPiece(nextPiece);
        System.out.println("current network after adding: "
            + next.toString());
  ...
  public Piece findNextPieceInDirection(Piece piece, int direction) {
    ...
    System.out.println("initial coordinate: " + pieceCoordinate[0] + " "
        + pieceCoordinate[1] + " direction: " + direction);
    int[] coordinate = incrementCoordinateInDirection(pieceCoordinate,
        direction);
    System.out.println("incremented coordinate: " + coordinate[0] + " "
        + coordinate[1]);
